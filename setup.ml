...
(* OASIS_START *)
(* DO NOT EDIT (digest: d9bb74ab49fa9f85ba33ef26a7a04075) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("irminsule.backend.git", None);
                           FindlibPackage ("sexplib", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\2202f\028T\031\146D\176\028\164\031\170\025\142J";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
