...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6b3bdf5905d4a0bde64b7799ddd11aa3) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$core_test", []))];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("cstruct",
                               Some (OASISVersion.VGreaterEqual "0.6.0"));
                   ...
                   {
                      lib_modules = ["Protocol"; "Handle"; "Client"; "S"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "xenstore";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("irmin.backend", None);
                           FindlibPackage ("irmin.backend.fs", None);
                           FindlibPackage ("git", None);
                           FindlibPackage ("git.fs", None);
                           FindlibPackage ("sexplib", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "xenstored";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "xenstore_client";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xenstore";
                      lib_findlib_name = Some "client";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "xenstore_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "core_test.ml"});
               Executable
                 ({
                     cs_name = "server_test";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "binary.ml"});
               Test
                 ({
                     cs_name = "core_test";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("shared-memory-ring.xenstore", None);
                           FindlibPackage ("xen-evtchn", None);
                           FindlibPackage ("xen-evtchn.unix", None);
                           FindlibPackage
                             ("xen-evtchn.unix.activations", None);
                           FindlibPackage ("io-page", None);
                           FindlibPackage ("io-page.unix", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["domains_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, ["-lxenctrl"])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])]
                   },
                   {exec_custom = true; exec_main_is = "main.ml"});
               Executable
                 ({
                     cs_name = "xs";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "cli.ml"});
               Executable
                 ({
                     cs_name = "bench";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "bench.ml"});
               Executable
                 ({
                     cs_name = "dbgring";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "dbgring.ml"})
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\134\235r\166m\249_\188]\167\t\022\249Z\182\211";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
