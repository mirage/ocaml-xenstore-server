...
val mount: Xenstore.Protocol.Path.t -> (module Tree.S) -> 'view Transaction.side_effects Lwt.t
...
val unmount: Xenstore.Protocol.Path.t -> 'view Transaction.side_effects Lwt.t
